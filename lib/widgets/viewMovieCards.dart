...
class viewMovieCards extends StatefulWidget {
  Movie movie;
  viewMovieCards({this.movie});
  @override
  _viewMovieCardsState createState() => _viewMovieCardsState();
}

class _viewMovieCardsState extends State<viewMovieCards> {
  String movieUrl;
